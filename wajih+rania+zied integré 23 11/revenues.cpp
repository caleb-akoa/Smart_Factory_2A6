...
bool Revenues::ajouterRevenues()
{
  ...
  query.prepare("insert into REVENUE (NOMPRODUIT,IDENTIFIANTREVENU,QUANTITEVENDUE,VALEURSUNITAIRE,IDENTIFIANTCLIENT,DATEVENTE)""values(:NOMPRODUIT,:ID_REVENUE,:QUANTITEVENDUE,:VALEURSUNITAIRE,:ID_CLIENT,:DATEVENTE)");

  query.bindValue(":NOMPRODUIT", this->NomProduit);
  query.bindValue(":IDENTIFIANTREVENU", res);
  query.bindValue(":QUANTITEVENDUE", this->QuantiteVendue);
  query.bindValue(":VALEURSUNITAIRE", this->ValeursUnitaire);
  query.bindValue(":IDENTIFIANTCLIENT", this->ID_Client);
...
bool Revenues::supprimerRevenues(int ID_Revenue )
{
    ...
    query.prepare("Delete from REVENUE where IDENTIFIANTREVENU= :IDENTIFIANTREVENU");
    query.bindValue(":IDENTIFIANTREVENU",res);
...
QSqlQueryModel * model=new QSqlQueryModel();
 ...
 model->setHeaderData(1,Qt::Horizontal,QObject::tr("IDENTIFIANTREVENU"));
 ...
 model->setHeaderData(4,Qt::Horizontal,QObject::tr("IDENTIFIANTCLIENT"));
...
bool Revenues::modifierRevenues(int ID_Revenue)
{
    ...
    query.prepare("Update REVENUE set NOMPRODUIT=:NOMPRODUIT,QUANTITEVENDUE=:QUANTITEVENDUE,VALEURSUNITAIRE=:VALEURSUNITAIRE,DATEVENTE=:DATEVENTE where IDENTIFIANTREVENU=:IDENTIFIANTREVENU");
    query.bindValue(":NOMPRODUIT", this->NomProduit);
    query.bindValue(":IDENTIFIANTREVENU", res);
    query.bindValue(":QUANTITEVENDUE", this->QuantiteVendue);
    query.bindValue(":VALEURSUNITAIRE", this->ValeursUnitaire);
...
query.prepare("select * from REVENUE where IDENTIFIANTREVENU=:IDENTIFIANTREVENU");
query.bindValue(":IDENTIFIANTREVENU", ID_Revenue);
...
query.prepare("select * from REVENUE where IDENTIFIANTCLIENT=:IDENTIFIANTCLIENT");
query.bindValue(":IDENTIFIANTCLIENT", ID_Client);
