...
private slots:
    ...
    void on_pushButton_chercherP24_clicked();

    void on_pushButton_chercheridm_clicked();

    void on_pushButton_c_clicked();

    void on_pushButton_cherchern_clicked();

    void on_pushButton_cherhcerIDF_clicked();
    ...
    void on_pushButton_mailEmploye_clicked();

    void on_afficher_6_clicked();

    void on_ajouter_6_clicked();

    void on_modifier_6_clicked();

    void on_ajouterclient_5_clicked();
    ...
    void on_modifier_14_clicked();

    void on_ajouter_22_clicked();

    void on_afficher_21_clicked();

    void on_modifier_19_clicked();

    void on_supprimer_20_clicked();

    void on_pushButton_24_clicked();

    void on_ajouter_24_clicked();

    void on_afficher_22_clicked();

    void on_modifier_20_clicked();

    void on_supprimer_21_clicked();
    ...
    void on_pushButton_temperateur_clicked();

    void on_envoyer_mail_client_clicked();

    void on_envoyer_facture_clicked();
